...
if connexion.connected() :
    ...
    urls = {'gares':               ['59593619a3a7291dd09c8238','d22ba593-90a4-4725-977c-095d1f654d28'],
            ...
            'temp_quot_région' :   ['5a5ddc1ab5950825e3ecba32','50b3f76f-b20c-4095-b3f1-96f5e26cbac6'],
            'observ_stat_météo' :  ['5369932ca3a729239d204103','66f4cfd9-240d-4c6e-8c0b-532d26c2c1dc'],
            'prix_m²_2017' :       ['5d6e64428b4c4179b3e88042','58b6b75e-4f15-4efb-adb5-3f7b939fb2d1'],
            'réseau_mobile' :      ['58c98b1888ee38770950152b','X'],
            'connexion_internet' : ['5e836644ca07c8558d91a6fc','X'],
            'haut_débit' :         ['547d8d7ac751df405d090fcb','X'],
            'établissements_scol': ['5889d042a3a72974cbf0d5b8','b3b26ad1-a143-4651-afd6-dde3908196fc'],
            'services_police' :    ['53ba5222a3a729219b7beade','2cb2f356-42b2-4195-a35c-d4e4d986c62b'],
            'musées' :             ['53699934a3a729239d2051a1','X']
            ...
            'éco_quartiers_2016' : ['588fb50dc751df5c03ae0a65','2b9cb88b-c05d-4c9e-a7dd-d71e6fd8ebb6']}
