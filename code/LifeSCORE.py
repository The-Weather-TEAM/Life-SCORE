...
for module in open(os.path.join(nom_du_repertoire, "systeme/modules.txt"), "r").readlines(): # os.pardir équivaut à ../ en linux
...
if nouvelle_bibliotheque == True :
    ...
    sys.exit(os.system(os.path.join(os.path.dirname(__file__), "LifeSCORE.py"))) # relance l'application
print("\n\n")
...
def fenetre_telechargement(bouton,fenetre, bouton_param, bouton_aide):
    ...
    try :
        ...
        if mise_a_jour.mettre_a_jour() :
            ...
            fenetre_Telechargement.focus_force() # Ajout de cette ligne pour éviter qur ça passe derrière la page principale
